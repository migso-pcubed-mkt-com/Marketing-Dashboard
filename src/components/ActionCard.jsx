    ...
    return (
        <div
            ...
            <div className="card-header">
                <div className="card-title" style={action.status === 'completed' ? {textDecoration:'line-through',color:'var(--text-muted)'} : action.trelloArchived ? {color:'var(--text-muted)'} : {}}>{action.trelloArchived && <span style={{fontSize:9,background:'var(--text-muted)',color:'white',borderRadius:3,padding:'1px 4px',marginRight:4,verticalAlign:'middle',fontWeight:600}}>ARCHIVED</span>}{action.trelloCardId && <span style={{display:'inline-flex',alignItems:'center',marginRight:4,color:'#0079bf',opacity:0.7,verticalAlign:'middle',flexShrink:0}} title="Synced with Trello"><svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor"><rect x="1" y="1" width="22" height="22" rx="3" opacity="0.15"/><rect x="3.5" y="3.5" width="7" height="13" rx="1.5" fill="currentColor"/><rect x="13.5" y="3.5" width="7" height="8" rx="1.5" fill="currentColor"/></svg></span>}{action.name}</div>
