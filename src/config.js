...
export const CONFIG = {
    ...
    STATUSES: [
        { id: 'todo', name: 'To Do', color: '#94a3b8', icon: '○' },
        { id: 'creating', name: 'Creating', color: '#f59e0b', icon: '✎' },
        { id: 'inprogress', name: 'In Progress', color: '#3b82f6', icon: '↻' },
        { id: 'review', name: 'In Review', color: '#d97706', icon: '◎' },
        { id: 'completed', name: 'Completed', color: '#22c55e', icon: '✓' },
        { id: 'paused', name: 'Paused', color: '#ef4444', icon: '⏸' }
    ],
    CATEGORIES: [
    ...
    CHANNELS: [
        ...
        { id: 'gads', name: 'Google Ads', color: '#ea4335' },
        { id: 'lads', name: 'LinkedIn Ads', color: '#0077b5' },
        { id: 'email', name: 'Email', color: '#f59e0b' },
        { id: 'press', name: 'Press', color: '#8b5cf6' },
        { id: 'events', name: 'Events', color: '#ec4899' },
        { id: 'seo', name: 'Article/SEO', color: '#10b981' },
        { id: 'web', name: 'Website', color: '#6366f1' },
        { id: 'video', name: 'Video', color: '#ef4444' },
        { id: 'lp', name: 'Landing Page', color: '#14b8a6' },
        { id: 'ia', name: 'IA', color: '#a855f7' },
        { id: 'auto', name: 'Automation', color: '#f97316' },
...
export const DEFAULT_TASKS = [
    { id: 't1', actionId: 'a1', month: 0, startDate: '2026-01-01', title: 'Vœux nouvel an', description: 'Post LinkedIn + Instagram', status: 'completed', priority: 'high', dueDate: '2026-01-15', checklist: [{ id: 'c1', text: 'Create visuel', done: true }, { id: 'c2', text: 'Rédiger texte', done: true }], comments: [{ id: 'cm1', author: 'Fabien', text: 'Bon engagement!', date: '2026-01-16' }], attachments: [], channels: ['social'] },
    ...
    { id: 't4', actionId: 'a1', month: 11, startDate: '2026-12-01', title: 'Vœux + Video Recap', description: 'Vidéo récap année', status: 'todo', priority: 'high', dueDate: '2026-12-20', checklist: [], comments: [], attachments: [], channels: ['social'] },
    { id: 't5', actionId: 'a2', month: 1, startDate: '2026-02-01', title: 'Content Février', description: 'Contenu marque employeur', status: 'inprogress', priority: 'medium', dueDate: '2026-02-28', checklist: [{ id: 'c3', text: 'Brief', done: true }, { id: 'c4', text: 'Production', done: false }], comments: [], attachments: [], channels: ['social', 'video'] },
    ...
    { id: 't7', actionId: 'a3', month: 1, startDate: '2026-02-01', title: 'Google Ads Fév', description: 'Budget 2000€', status: 'inprogress', priority: 'high', dueDate: '2026-02-28', budget: 2000, checklist: [{ id: 'c5', text: 'Setup', done: true }], comments: [], attachments: [], channels: ['gads'] },
    { id: 't8', actionId: 'a3', month: 2, startDate: '2026-03-01', title: 'Google Ads Mar', description: 'Budget 2000€', status: 'creating', priority: 'high', dueDate: '2026-03-31', budget: 2000, checklist: [], comments: [], attachments: [], channels: ['gads'] },
    { id: 't9', actionId: 'a3', month: 3, startDate: '2026-04-01', title: 'Google Ads Avr', description: 'Budget 2000€', status: 'todo', priority: 'high', dueDate: '2026-04-30', budget: 2000, checklist: [], comments: [], attachments: [], channels: ['gads'] },
    { id: 't10', actionId: 'a4', month: 1, startDate: '2026-02-01', title: 'LinkedIn Ads Fév', description: 'Budget 3000€', status: 'inprogress', priority: 'high', dueDate: '2026-02-28', budget: 3000, checklist: [], comments: [], attachments: [], channels: ['lads'] },
    { id: 't11', actionId: 'a4', month: 2, startDate: '2026-03-01', title: 'LinkedIn Ads Mar', description: 'Budget 3000€', status: 'creating', priority: 'high', dueDate: '2026-03-31', budget: 3000, checklist: [], comments: [], attachments: [], channels: ['lads'] },
    ...
    { id: 't16', actionId: 'a9', month: 1, startDate: '2026-02-01', title: 'Google Lead Gen Fév', description: 'Budget 2000€', status: 'inprogress', priority: 'high', dueDate: '2026-02-28', budget: 2000, checklist: [], comments: [], attachments: [], channels: ['gads', 'lp'] },
    { id: 't17', actionId: 'a10', month: 2, startDate: '2026-03-01', title: 'LinkedIn Lead Gen Mar', description: 'Budget 3000€', status: 'todo', priority: 'high', dueDate: '2026-03-31', budget: 3000, checklist: [], comments: [], attachments: [], channels: ['lads', 'lp'] },
    { id: 't18', actionId: 'a11', month: 3, startDate: '2026-04-01', title: 'Event In-House Avril', description: 'Événement interne', status: 'todo', priority: 'high', dueDate: '2026-04-15', budget: 10000, checklist: [{ id: 'c8', text: 'Lieu', done: false }, { id: 'c9', text: 'Invitations', done: false }], comments: [], attachments: [], channels: ['events'] },
